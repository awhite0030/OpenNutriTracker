...
void main() {
  ...
  testWidgets('the collapsed summary counts the enabled sources', (
    ...
    // Four of six selectable sources on, plus Open Food Facts, which is
    // always searched and has no switch: 5 of 7.
    await pumpPage(
      tester,
      toggles: {
        'fdc_foundation': true,
    ...
    expect(
      find.text(l10nEn.onboardingFoodSourcesEnabledCount(5, 7)),
      findsOneWidget,
    );
  });
