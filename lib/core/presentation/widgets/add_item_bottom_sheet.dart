...
class AddItemBottomSheet extends StatelessWidget {
    ...
    return Semantics(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.labelSmall?.copyWith(color: scheme.onSecondaryContainer, fontWeight: FontWeight.w600),
        ),
      ),
    );
  }
  ...
  void _showAddItemScreen(BuildContext context, AddMealType itemType) {
    ...
    Navigator.of(context).pushNamed(NavigationOptions.addMealRoute, arguments: AddMealScreenArguments(itemType, day));
  }
  ...
  void _showAddActivityScreen(BuildContext context) {
    ...
    Navigator.of(
      context,
    ).pushNamed(NavigationOptions.addActivityRoute, arguments: AddActivityScreenArguments(day: day));
  }
}
